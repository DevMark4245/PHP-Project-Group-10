                    ...
                    <div class="col-md-6 col-sm-6">
                      <article class="mu-blog-single-item">
						...
						<?php
						  ...
						  ?>
                          <a href="reviewsingle.php?id=<?php echo $row['review_id']?>"><img src="<?php echo $row2['college_image']?>" alt="img" width="331.75" height = "176.38"></a>
                          <figcaption class="mu-blog-caption">
                            <h3><a href="reviewsingle.php?id=<?php echo $row['review_id']?>"><?php echo $row['review_title']?></a></h3>
                          </figcaption>                      
                        </figure>
